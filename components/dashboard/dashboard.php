<div class="app">
    <!-- header -->
    <?php
    include_once "components/dashboard/shared/header.php"
    ?>
    <div class="app-body">
        <!-- Side Bar -->
        <?php
        include_once "components/dashboard/shared/ASide.php"
        ?>
        ...
        <!-- New Payment -->
        <?php
        include_once "components/dashboard/shared/aRightSide.php"
        ?>
    </div>
</div>